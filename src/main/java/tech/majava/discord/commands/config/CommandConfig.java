...
/**
 * <p><b>Class {@link tech.majava.discord.commands.config.CommandConfig}</b></p>
 *
 * @author majksa
 * @version 1.0.0
 * @since 1.0.0
...
public class CommandConfig implements Config {
    ...
    @Nullable
    @JsonAlias("class")
    private Class<Command<?>> command = null;
    ...
    @Nonnull
    private List<GroupConfig> groups = new LinkedList<>();
